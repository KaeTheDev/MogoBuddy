                    ...
                    <div className="col s8 offset-s2">
                        ...
                        <form noValidate onSubmit={this.onSubmit}>
                            <div className="input-field col s12">
                                ...
                                error = {errors.name} id = "name" type = "text" />
                            ...
                            <div className = "input-field col s12">
                                ...
                                error = { errors.password } id = "password" type = "password" />
                            ...
                            <div className = "col s12" style = {{paddingLeft: "11.250px"}}>
                                ...
                                marginTop: "1rem"}} type ="submit" className = "btn btn-large waves-effect waves-light hoverable blue accent-3">
                                    Sign Up
                                </button>
                            </div>
                        </form>
